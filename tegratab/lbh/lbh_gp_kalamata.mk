...
$(GP_LBH_BUILD_PROP_TARGET): $(LOCAL_PATH)/lbh.prop
	...
	$(hide) echo "ro.product.board=F4C58UA" >> $@
...
#application and boot animation
GP_LBH_COPY_FILES += \
   vendor/nvidia/kalamata/media/bootanimation.zip:$(GP_LBH_TAG)/media/bootanimation.zip \
   vendor/nvidia/kalamata/apps/BoxAndroidAppMarket-default-2013.06.24.13.30-v2.1.9_hotfix_1-d16b9b7-release.apk:$(GP_LBH_TAG)/app/BoxAndroidAppMarket-default-2013.06.24.13.30-v2.1.9_hotfix_1-d16b9b7-release.apk \
   vendor/nvidia/kalamata/apps/ConnectedPhotoApp_1.0.325.2600.apk:$(GP_LBH_TAG)/app/ConnectedPhotoApp_1.0.325.2600.apk \
   vendor/nvidia/kalamata/apps/ePrint-release-9136443.apk:$(GP_LBH_TAG)/app/ePrint-release-9136443.apk \
   vendor/nvidia/kalamata/apps/FileManager-HPF130219_01-1.0.17486.apk:$(GP_LBH_TAG)/app/FileManager-HPF130219_01-1.0.17486.apk \
   vendor/nvidia/kalamata/apps/skype_raider_stub-2.1.443.38.apk:$(GP_LBH_TAG)/app/skype_raider_stub-2.1.443.38.apk \
