...
ifeq ($(wildcard vendor/nvidia/tegra/apps/diagsuite/bin),vendor/nvidia/tegra/apps/diagsuite/bin)
PRODUCT_COPY_FILES += \
    vendor/nvidia/tegra/apps/diagsuite/bin/stress_test.sh:system/bin/stress_test.sh \
