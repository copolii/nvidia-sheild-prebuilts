...
PRODUCT_COPY_FILES += \
  ...
  $(LOCAL_PATH)/legal/shield_legal.html:system/etc/shield_legal.html \
  $(LOCAL_PATH)/legal/tos.html:system/etc/tos.html \
  $(LOCAL_PATH)/legal/priv.html:system/etc/priv.html \
  $(LOCAL_PATH)/legal/shield_legal_zh_tw.html:system/etc/shield_legal_zh_tw.html \
  $(LOCAL_PATH)/legal/tos_zh_tw.html:system/etc/tos_zh_tw.html \
  $(LOCAL_PATH)/legal/priv_zh_tw.html:system/etc/priv_zh_tw.html \
  $(LOCAL_PATH)/legal/shield_legal_zh_cn.html:system/etc/shield_legal_zh_cn.html \
...
$(call inherit-product-if-exists, vendor/nvidia/roth/rothui.mk)
